...
\frametitle{Work in Progress\\K2 observations of Stripe 82 QSOs}
        ...
        \end{figure}
        Add HSC data from Stripe 82?
\end{frame}

\begin{frame}
\frametitle{Work in Progress\\Beaming from binary SMBHs}
        \begin{figure}
          \includegraphics[scale=0.25]{images/tau10yrs_a0.01au_m10^10msun_PSD.jpg}
        \end{figure}
        Effect of beaming due to binary SMBH with $M_{12} = 10^{10} M_{\sun}$; $a = 0.01$ au
\end{frame}
